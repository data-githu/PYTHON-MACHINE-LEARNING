# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 14:32:04 2021

@author: Owner
"""

# ■ 2장. 나이브 베이즈 - 실습 2. 유방암 데이터
...
print(accuracy) # 0.9415204678362573


#%%
# 문제9. 위의 나이브 베이즈 모델을 생성할 때 위에서는 min/max 정규화를 했는데 이번에는 scale 함수를 적용해서 수행하고 정확도를 확인하시오
import pandas as pd # 데이터 전처리
import seaborn as sns # 시각화
